...
<title>PayPal SDK - GetBasicPersonalData</title>
...
<body>
	<div id="wrapper">
		<div id="header">
			...
			<div id="apidetails">GetBasicPersonalData API operation is used
				to obtain basic personal data for an account holder.</div>
		</div>
		<form method="POST">
			<div id="request_form">
				<div class="params">
				...
				<div class="params">
					<div class="param_name">Basic Attributes*</div>
					<div class="param_value">
