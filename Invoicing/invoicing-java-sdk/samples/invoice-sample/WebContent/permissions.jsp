...
%>
<br/>
<input type="checkbox" name="authentication" id="authentication" <%=checkboxAttrib%> onclick="toggleDisplay('permissions');"/>
<label for="authentication">Use Permission Credentials</label>
<a href='RequestPermissions?page=<%=request.getParameter("source")%>'>Get permissions credentials here</a><br />
