<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateRecurringPaymentsProfile.aspx.cs" Inherits="PayPalAPISample.APICalls.UpdateRecurringPaymentsProfile" %>
...
<body>
    <div id="wrapper">
    <div id="header">
        <h3>UpdateRecurringPaymentProfile</h3>
        <div id="apidetails">Update a recurring payments profile.</div>
    </div>
    <form id="form1" runat="server">
        <div id="request_form">
            ...
            <div class="param_name">Additional billing cycles</div>
            <div class="param_value">
                <input type="text" name="additionalBillingCycles" id="additionalBillingCycles" value="" runat="server" />
            </div>                        
            <div class="param_name">Currency</div>
            <div class="param_value">
            ...
            <div class="param_name">Outstanding Balance</div>
            <div class="param_value">
