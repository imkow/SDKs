namespace PayPal.AdaptivePayments.Model
{
    ...
    public partial class ReceiverIdentifier : AccountIdentifier
    {
        ...
        public ReceiverIdentifier(Dictionary<string, string> map, string prefix)
            : base(map, prefix)
        {
            string key = "";
        }
    ...
    public partial class SenderIdentifier : AccountIdentifier
    {
        ...
        public SenderIdentifier(Dictionary<string, string> map, string prefix)
            : base(map, prefix)
        {
    ...
    public partial class SenderOptions
    {
        ...
        {
            string key = prefix + "requireShippingAddressSelection";
            if (map.ContainsKey(key))
            {
